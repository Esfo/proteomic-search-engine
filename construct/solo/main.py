...
librarycommands['missedcleavages'] = 1
...
searchcommands['ms1_ppmtolerance'] = 25
searchcommands['ms2_ppmtolerance'] = 20
...
if __name__ == '__main__':
    ...
    if primarycommand == 'search':
        ...
        if proceed:
            ...
            #MEMORY ISSUES on big files, is this useful? god damn
            #from entropycompetition import entropy_competition
            #entropy_competition(searchcommands['file'], searchcommands['processingdirectory'], searchcommands['ppmtolerance'], searchcommands['nprocs'])
