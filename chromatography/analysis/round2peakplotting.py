...
folder = '/store/flowcharacterizations/round2/DDAs/'
...
for fr in files:
    ...
    gname = ''.join((gradientsfolder, '-'.join((fbase.split('_')[1].split('-')[:-1])), '.method.csv'))
    try:
...
results = pd.read_csv('/store/flowcharacterizations/round2/DDAs/MGFs/results.csv')
